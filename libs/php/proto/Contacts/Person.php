...
/**
 * Generated from protobuf message <code>Contacts.Person</code>
 */
class Person extends \Google\Protobuf\Internal\Message
{
     ...
     *           Unique ID number for this person.
     *     @type string $email
     *     @type \Contacts\Person\PhoneNumber[]|\Google\Protobuf\Internal\RepeatedField $phones
    ...
    /**
     * Generated from protobuf field <code>repeated .Contacts.Person.PhoneNumber phones = 4;</code>
     * @param \Contacts\Person\PhoneNumber[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPhones($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Contacts\Person\PhoneNumber::class);
        $this->phones = $arr;
